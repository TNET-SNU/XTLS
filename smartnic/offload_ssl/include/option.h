...
#define VERBOSE_PER_SEC         FALSE
#define VERBOSE_RECV_Q_CNT      FALSE
#define VERBOSE_IF_STAT         FALSE
...
#define REMOVE_HWS                       0 // for testing
...
#define MEASURE(name, cmd)                                                    \
    ...
    {                                                                         \
        ...
        fprintf(stderr,                                                       \
                "[%-20s] Wallclock time: %.2lf, Thread time: %.2lf\n",        \
                name,                                                         \
                (double)_time1 / E9 * E6,                                     \
                (double)_time2 / E9 * E6);                                    \
    } while (/* CONSTCOND */ 0);
